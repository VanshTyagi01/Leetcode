class Solution {
    public int orangesRotting(int[][] grid) {
        ...
        int minutes = 0;
        int directions[][] = {{1,0},{-1,0},{0,1},{0,-1}}; // all four direction
        while(!queue.isEmpty()){
            int size = queue.size();
            ...
            for(int i=0; i<size; i++){
                ...
                for(int[] direction: directions){
                    ...
                    if(newRowDirection >=0 && newRowDirection < rows && newColDirection >= 0 && newColDirection < cols
                    && grid[newRowDirection][newColDirection] == 1){
